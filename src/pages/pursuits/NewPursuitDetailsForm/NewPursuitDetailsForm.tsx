// src/pages/NewPursuitDetailsForm.tsx
import React, { useState, useEffect, useContext } from "react";
import { useNavigate } from "react-router-dom";
import { v4 as uuidv4 } from "uuid";
import styles from "../create-pursuit/NewPursuitPage.module.css";
...
const NewPursuitDetailsForm: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      // Luego de guardar, navega a la pestaña "Team"
  ...
  return (
    <form onSubmit={handleSubmit} className={styles.form}>
      ...
      <div className={styles.formRow}>
        <div className={styles.formGroup}>
          <label>
            Are there any security procedures, additional background checks, or similar?
          </label>
          <textarea
